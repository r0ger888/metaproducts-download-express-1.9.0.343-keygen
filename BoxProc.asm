...
InfoText 	db	"PERYFERiAH tEAM PrEsEnT",13,13
			db  "MetaProducts Download Express",0FFh
			db  "v1.9.343 Keygen",0FFh,13
			db  "gfx'ed & keygenned by",13
			db  "r0ger ^ PRF",0FFh,13
			db  "protection used:",13
			db  "RSA-370 + base64",0FFh
			db  "(incl. all blacklisted names)",0FFh,13,13
			db  "too lazy to put the app's",13
			db  "description right here,",13
			db  "i'd prefer to put it on the",13
			db  "PRF.nfo (which is along with",13
			db  "this keygen) as it takes",13
			db  "much time to search for that",13
			db  "from different websites like",13
			db  "softpedia, softoroom & etc..",13,13,13
...
loc_4014A0:
		invoke SetTextColor,hdcSrc,00F5A563h
